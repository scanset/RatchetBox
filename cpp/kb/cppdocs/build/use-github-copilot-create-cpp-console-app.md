...
1. Ensure **Desktop development with C++** is checked:
    ...
    :::image type="content" source="media/desktop-development-cpp-workload.png" alt-text="Screenshot of the Visual Studio Installer with the Workloads tab selected and Desktop Development with C++ selected.":::
...
You prompt Copilot by describing the functionality you want. In this section, you learn how to prompt Copilot to generate an implementation of Conway's Game of Life.
...
1. Copilot generates C++ code for Conway's Game of Life. Copy the generated code and paste it into your empty `Life.cpp` file.
...
Your generated code likely includes these key components:
...
:::image type="content" source="./media/vs-2026/github-copilot-fix-warning-accept.png" alt-text="Screenshot of the Copilot proposed changes, explanation to use Tab to accept or Alt+Del to discard.":::
