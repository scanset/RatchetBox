...
list of the arguments to bind to the (1,2) first or (3,4) last sizeof...(Args) parameters of the callable target
...
202306L
(C++26)
Allow passing callable objects as non-type template arguments to std::bind_front, (2)
...
202306L
(C++26)
Allow passing callable objects as non-type template arguments to std::bind_back, (4)
