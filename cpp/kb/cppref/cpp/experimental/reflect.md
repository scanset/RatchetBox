...
nested-name-specifier(optional) namespace-name
...
a value of at least 201902 indicates that the support library of the Reflection TS is supported 
(macro constant)
...
class-name designating a union
...
reflect::Type, reflect::Alias, reflect::ScopedMember
...
reflect::Namespace, reflect::Alias
