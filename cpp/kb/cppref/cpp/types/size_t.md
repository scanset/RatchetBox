...
std::size_t was circularly defined[1]
...
object size might be not representable in std::size_t

such type is ill-formed

- ↑ The definition of std::size_t was exactly the same as the definition of size_t in C, which is “the result type of sizeof”. There is no circular definition in C because the result type of sizeof in C is an implementation-defined unsigned integer type.
...
binary,(since C++14) decimal, octal, or hexadecimal numbers of integer type
