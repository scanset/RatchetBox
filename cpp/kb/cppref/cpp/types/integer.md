...
output of a signed decimal integer value
...
output of an unsigned decimal integer value
...
output of an unsigned octal integer value
...
output of an unsigned lowercase hexadecimal integer value
...
output of an unsigned uppercase hexadecimal integer value
...
input of a signed decimal integer value
...
input of a signed integer value
...
input of an unsigned decimal integer value
...
input of an unsigned octal integer value
...
input of an unsigned hexadecimal integer value
...
the requirements for optional typedef names and macros were inconsistent with C
