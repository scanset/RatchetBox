...
array types could not be value types
...
past-the-end iterators were always non-singular
...
the validity of an iterator was not defined

defined to be always non-singular

LWG 324

C++98

output iterators had value types

output iterators have writable types instead

LWG 407

C++98

singular iterators could not be destroyed
...
singular iterators could not be copied

allowed if they are value-initialized
...
always satisfy LegacyOutputIterator
...
the definition of iterator singularity and
...
<string_view> did not provide the
