...
the label applied to the statement (defined below)

statement

-

the statement which the label applies to, it can be a labeled statement itself, allowing multiple labels
