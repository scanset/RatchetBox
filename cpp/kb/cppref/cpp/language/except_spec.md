...
comma-separated list of type-ids, a type-id representing a pack expansion is followed by an ellipsis (...)(since C++11)
...
the behavior of assignment and initialization
...
exception specification may contain functions types, but the
...
an exception specification might be eagerly instantiated
...
rvalue reference types were allowed in exception specifications
...
throw(T...) was not a non-throwing
...
the set of potential exceptions of a typeid expression
