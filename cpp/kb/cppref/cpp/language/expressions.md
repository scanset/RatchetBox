...
assigning a value to a volatile variable might
...
sequencing of destructor calls in
...
the list of expressions where lvalue-to-rvalue
...
the invocations of the destructors of temporaries that
