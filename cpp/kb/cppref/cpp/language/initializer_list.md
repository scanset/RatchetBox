...
name of a variadic template parameter pack
...
the declarator syntax of constructor only allowed
at most one function specifier (e.g. a constructor
cannot be declared inline explicit)
...
it was unspecified whether an abstract class should
...
anonymous union members without default
