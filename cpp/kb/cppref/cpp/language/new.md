...
a parentheses-enclosed expression list or a brace-enclosed initializer list(since C++11)

placement-args

-

additional placement arguments
...
- If new-initializer is a braced-enclosed initializer list, the array is aggregate-initialized.
...
value in the first dimension must have integral type
...
value in the first dimension must
...
the behavior was unspecified when the
...
non-allocating placement new need
...
it was unclear whether default/value-initialization is
...
non-allocating placement array new
...
the program might be ill-formed even if the
