...
the class whose default constructor is being declared

parameter-list

-

a parameter list where all parameters (except parameter packs)(since C++11) have default arguments

function-body

-

the function body of the default constructor
...
- No default constructor whose associated constraints are satisfied is more constrained.
...
the conditions where implicitly-declared default constructors
