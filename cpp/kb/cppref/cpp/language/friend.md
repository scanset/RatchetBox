...
the keyword typename followed by a qualified identifier or qualified simple template identifier
...
members of a class nested in a friend
...
friend class of T cannot inherit from private or
...
the rule targeting friend declarations in non-local
...
a name first declared in a friend declaration within a class
...
when a member of a class template is friended, the corresponding
...
friend declarations referring to full specializations
...
the linkages of names introduced by friend declarations were unclear
...
defines types holding several data members

Access specifiers 

defines visibility of class members