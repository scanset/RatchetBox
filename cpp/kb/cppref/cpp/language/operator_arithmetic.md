...
the algebraic quotient of integer division was
...
the result of a / b was unspecified if
...
the behavior of shifting the leftmost 1 bit of a
...
a pointer to a base class subobject of an array
...
only unsigned integers which declared unsigned 
...
arithmetic operators allow their operands to be lvalues

some operands must be rvalues

CWG 1865

C++98

the resolution of CWG issue 1504 made the behaviors
...
it was unclear whether the rule resolving the
...
the result of built-in operator~ was simply
...
the rounding direction of arithmetic right shift was unclear
...
a pointer past the end of an object could
