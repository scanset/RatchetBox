...
member access and member access through
...
1. 
C++ value categories and decltype demystified — David Mazières, 2021

2. 
Empirically determine value category of expression — StackOverflow