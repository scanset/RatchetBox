...
the class whose move assignment operator is being declared, the class type is given as T in the descriptions below

parameter-list

-

a parameter list of only one parameter, which is of type T&&, const T&&, volatile T&& or const volatile T&&
...
the function body of the move assignment operator

return-type

-

any type, but T& is favored in order to be consistent with scala types
...
The implicitly-defined move assignment operator for a class T is constexpr if
...
The implicitly-defined move assignment operator for a class T is constexpr.
...
- No move assignment operator whose associated constraints are satisfied is more constrained.
...
the conditions where defaulted move assignment operators are
...
a defaulted move assignment operator that would
...
specification for a defaulted move assignment operator
...
a volatile subobject made of a defaulted
...
a defaulted move assignment operator for class T
...
a move assignment operator was not eligible if there
...
the implicitly-defined move assignment operator for
