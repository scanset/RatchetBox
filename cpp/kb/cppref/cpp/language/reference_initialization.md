...
a function with a parameter of reference type (T ﻿& or T ﻿&&(since C++11))

func-refret

-

a function whose returns type is a reference type (T ﻿& or T ﻿&&(since C++11))
...
a non-static data member of reference type (T ﻿& or T ﻿&&(since C++11)) of Class
...
initialize a reference to const-qualified type with a class type
...
a reference to const-qualified array could not be
...
a reference could not bind directly to an array or class rvalue
...
a reference to const-qualified type initialized with a type which is not
...
the conversion from target of class type to another
...
a reference could bind to a bit-field xvalue
...
the definition of temporary was unclear
...
user-defined conversions in indirect
...
user-defined conversions were not considered in indirect binding
...
reference compatibility did not consider qualification conversions
...
cv-qualification was not added to the result type
...
reference-related types were allowed for indirect binding
