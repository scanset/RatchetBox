...
another flat_map to be used as source to initialize the elements of the underlying containers with
...
a disambiguation tag that indicates that the input sequence is sorted with respect to value_comp() and all its elements are unique
