...
1,2) Elements are compared using std::less<T>()(until C++14)std::less<>()(since C++14).
...
3,4) At most \(\scriptsize N+R-1\)N+R-1 applications of the comparison function comp.
...
the effect when *this and other refer
