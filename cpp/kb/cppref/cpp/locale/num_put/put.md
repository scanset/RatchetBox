...
the bool overload used non-existing members
truename and falsename of std::ctype

use these members of std::numpunct

LWG 231

C++98

the precision modifier was only added if
...
the thousand separators were only inserted for integral types in stage 2

also inserted for floating-point types
