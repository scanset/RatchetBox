...
the process of parsing text boolean values was errornous
...
the overload of get taking bool& value was missing
...
overflowing input resulted in undefined behavior
...
the conversion specifier for double was %g (same as float)
...
do_get did not parse 'x' and 'X' while strtol parsed them
...
get had an overload taking short& value instead of float&
...
thousand separators after the decimal point were ignored
...
the result was unchanged on conversion failure
...
overflow handling was inconsistent between floating-point types
...
do_get did not parse 'p' and 'P' while strtod parsed them
