...
another numeric array (or a mask) to assign
...
the behaviors of overloads (4-7) were
...
the behavior of the copy assignment operator
...
the move assignment operator resized
