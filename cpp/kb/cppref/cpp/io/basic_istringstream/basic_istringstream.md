...
buf_type(mode | std::ios_base::in)

(2)

buf_type(std::ios_base::in)

(3)

buf_type(str, mode | std::ios_base::in)

(4)

buf_type(std::move(str), mode | std::ios_base::in)

(5)

buf_type(mode | std::ios_base::in, a)

(6)

buf_type(str, mode | std::ios_base::in, a)

(7)

buf_type(str, std::ios_base::in, a)
...
{t, mode | std::ios_base::in, Allocator()}

(10)

{t, mode | std::ios_base::in, a}
...
move constructed from other's std::basic_istream base
