...
expands to the line number of the current physical source line, an integer constant, can be changed by the #line directive 
(macro constant)
...
it was unclear whether __LINE__ expands to the current
...
a translation unit that includes a standard library header could contain
...
universal character names were not allowed
