...
Any member of the source character set(until C++23)translation character set(since C++23) except new-line and >
...
the behavior is undefined if an escape sequence is
