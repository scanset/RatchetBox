...
iterator-sentinel defining the source range to copy from
...
iterator-sentinel defining the destination range
...
projection to apply to the elements of source range

proj2

-

projection to apply to the elements of destination range
