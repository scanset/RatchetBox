...
the parameter end of time_get::do_get_monthname
...
the type of the parameter state of members length and do_length
...
the return types of members do_scan_is and do_scan_not
...
all virtual member functions of XXX_byname
...
the semicolons following the declarations of the default constructor
...
there was an explicit specialization
