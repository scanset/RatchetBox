...
- _Bool, for single-bit bit-fields (e.g. bool x : 1;) has the range [​0​, 1] and implicit conversions to and from it follow the boolean conversion rules.
