...
enum attr-spec-seq ﻿(optional) identifier ﻿(optional) : type { enumerator-list }
...
enumeration-constant attr-spec-seq ﻿(optional) = constant-expression
...
integer constant expression whose value is representable as a value of type int(until C23). If the enumeration has a fixed underlying type, representable as a value of type(since C23)

attr-spec-seq

-

(C23)optional list of attributes,
