...
The alignment requirement of a type can be queried with _Alignof(until C23)alignof(since C23).
...
a type might have extended alignment without _Alignas involved

it must have fundamental alignment
