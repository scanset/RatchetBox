...
A pointer to a char* or wchar_t* which will contain the formatted output

fmt

-

A format string as with printf/wprintf and related functions

arg

-

Any extra arguments are used as with vsprintf and vswprintf
