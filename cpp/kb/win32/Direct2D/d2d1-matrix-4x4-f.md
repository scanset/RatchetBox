...
**D2D1\_MATRIX\_4X4** is a new name for the [**D2D\_MATRIX\_4X4\_F**](/windows/desktop/api/dcommon/ns-dcommon-d2d_matrix_4x4_f) structure. For a list of fields provided by the matrix, see **D2D\_MATRIX\_4X4\_F**.
