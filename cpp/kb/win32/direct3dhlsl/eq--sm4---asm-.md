...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[in\] The component to comapre to *src1*.<br/>         |
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[in\] The component to comapre to *src0*.<br/>         |
...
If the comparison is true, 0xFFFFFFFF is returned for that component. Otherwise 0x0000000 is returned.
