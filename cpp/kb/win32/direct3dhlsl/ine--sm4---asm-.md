...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[in\] Contains the value to compare to *src1*.<br/>    |
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[in\] Contains the value to compare to *src0*.<br/>    |
