...
| [BN_DISABLE](bn-disable.md) | Sent when a button is disabled. **Note:** This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [**BS_OWNERDRAW**](button-styles.md) button style and the [**DRAWITEMSTRUCT**](/windows/win32/api/winuser/ns-winuser-drawitemstruct) structure for this task.<br> The parent window of the button receives the [BN_DISABLE](bn-disable.md) notification code through the [**WM_COMMAND**](/windows/desktop/menurc/wm-command) message.<br> | 
...
| [BN_HILITE](bn-hilite.md) | Sent when the user selects a button. **Note:** This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [**BS_OWNERDRAW**](button-styles.md) button style and the [**DRAWITEMSTRUCT**](/windows/win32/api/winuser/ns-winuser-drawitemstruct) structure for this task.<br> The parent window of the button receives the [BN_HILITE](bn-hilite.md) notification code through the [**WM_COMMAND**](/windows/desktop/menurc/wm-command) message.<br> | 
...
| [BN_PAINT](bn-paint.md) | Sent when a button should be painted. **Note:** This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [**BS_OWNERDRAW**](button-styles.md) button style and the [**DRAWITEMSTRUCT**](/windows/win32/api/winuser/ns-winuser-drawitemstruct) structure for this task.<br> The parent window of the button receives the [BN_PAINT](bn-paint.md) notification code through the [**WM_COMMAND**](/windows/desktop/menurc/wm-command) message. <br> | 
| [BN_PUSHED](bn-pushed.md) | Sent when the push state of a button is set to pushed. **Note:** This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [**BS_OWNERDRAW**](button-styles.md) button style and the [**DRAWITEMSTRUCT**](/windows/win32/api/winuser/ns-winuser-drawitemstruct) structure for this task.<br> The parent window of the button receives the [BN_PUSHED](bn-pushed.md) notification code through the [**WM_COMMAND**](/windows/desktop/menurc/wm-command) message.<br> | 
...
| [BN_UNHILITE](bn-unhilite.md) | Sent when the highlight should be removed from a button. **Note:** This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [**BS_OWNERDRAW**](button-styles.md) button style and the [**DRAWITEMSTRUCT**](/windows/win32/api/winuser/ns-winuser-drawitemstruct) structure for this task.<br> The parent window of the button receives the [BN_UNHILITE](bn-unhilite.md) notification code through the [**WM_COMMAND**](/windows/desktop/menurc/wm-command) message.<br> | 
| [BN_UNPUSHED](bn-unpushed.md) | Sent when the push state of a button is set to unpushed. **Note:** This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [**BS_OWNERDRAW**](button-styles.md) button style and the [**DRAWITEMSTRUCT**](/windows/win32/api/winuser/ns-winuser-drawitemstruct) structure for this task.<br> The parent window of the button receives the [BN_UNPUSHED](bn-unpushed.md) notification code through the [**WM_COMMAND**](/windows/desktop/menurc/wm-command) message.<br> | 
