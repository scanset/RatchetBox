...
![screen shot showing a dialog box with a horizontal trackbar and a vertical trackbar](images/tkb-buddy.png)
...
**IDC\_SLIDER1** and **IDC\_SLIDER2** are trackbars created in the resource editor.
