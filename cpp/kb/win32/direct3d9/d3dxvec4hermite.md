...
Pointer to a source [**D3DXVECTOR4**](d3dxvector4.md) structure, a tangent vector.
...
Pointer to a [**D3DXVECTOR4**](d3dxvector4.md) structure that is the result of the Hermite spline interpolation.
