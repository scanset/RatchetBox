...
| [MF\_SOURCE\_READER\_PASSTHROUGH\_MODE](mf-source-reader-mediasource-config.md)                                   | When this attribute is set, the [Source Reader](source-reader.md) passes through video samples backed by the system memory to internal MFTs without automatically copying them into a DirectX texture, even if a Direct3D device manager is present.                                                                                                                                                                            |
