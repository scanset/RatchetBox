...
| [MF_MT_AUDIO_SAMPLES_PER_SECOND](mf-mt-audio-samples-per-second-attribute.md) | Sample rate, in samples per second. | Optional. Valid values are: 48000, 44100, 32000, 24000, 22050, and 16000. If this attribute is not set, the default value is 48000. <br> **Note:** Dolby AC-3 streams are limited to the three highest rates in this list.<br> | 
...
| 3/0 | 3 | 0x7 (<strong>SPEAKER_FRONT_LEFT</strong> <strong>SPEAKER_FRONT_RIGHT</strong> <strong>SPEAKER_FRONT_CENTER</strong>) | 
...
| 3/2/2 + LFE **Note:** Dolby Digital Plus only.<br> | 8 | 0x63F (**SPEAKER_FRONT_LEFT** **SPEAKER_FRONT_RIGHT** **SPEAKER_FRONT_CENTER** **SPEAKER_LOW_FREQUENCY** **SPEAKER_BACK_LEFT** **SPEAKER_BACK_RIGHT** **SPEAKER_SIDE_LEFT** **SPEAKER_SIDE_RIGHT**) | 
