...
-   Some TCP stack optimizations do not apply to fully accepted connections even after the conditional accept completes. This may reduce performance of the connection over its entire lifetime.
