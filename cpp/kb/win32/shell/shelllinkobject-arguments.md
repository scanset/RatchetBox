...
the link's arguments.

## Examples

The following example uses **Arguments** to retrieve the arguments for a link to Internet Explorer found in the user's Start menu. Proper usage is shown for JScript, VBScript, and Visual Basic.
