...
The sequencing of many actions in the actions tables is restricted. See [Standard Actions Reference](standard-actions-reference.md) for a complete list of actions with links to detailed sequencing information.
...
[RemoveFolders](removefolders-action.md)
