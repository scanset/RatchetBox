The C# file you wrote for {{ path }} did NOT build. Fix EVERY error below. Output ONLY the corrected C#
source - no prose, no markdown fences. Stay in the C# 5 subset (no `$"..."`, `?.`, expression-bodied
members, tuples).
