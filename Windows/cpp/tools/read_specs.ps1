...
# for the compose/plan step to consume. The model reads these (unordered, possibly inconsistent) and
# infers a build plan. Arg: dir (relative to the ratchet root, or absolute). Domain-agnostic.
param([string] $Dir)
