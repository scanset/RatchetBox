...
| r\#      | [Temporary Register](dx9-graphics-reference-asm-vs-registers-temporary.md)               | See note 2 | R/W | 3             | Unlimited       | 4         | No      | None         | No           |
| c\#      | [Constant Float Register](dx9-graphics-reference-asm-vs-registers-constant-float.md)     | See note 3 | R   | 1             | 2               | 4         | a0 / aL | (0, 0, 0, 0) | No           |
...
2.  Equal to D3DCAPS9.VS20Caps.NumTemps (at least 12 for vs\_2\_x).
3.  Equal to D3DCAPS9.MaxVertexShaderConst (at least 256 for vs\_2\_x).
