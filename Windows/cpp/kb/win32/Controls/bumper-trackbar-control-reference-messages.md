...
-   [**TBM\_CLEARSEL**](tbm-clearsel.md)
-   [**TBM\_CLEARTICS**](tbm-cleartics.md)
-   [**TBM\_GETBUDDY**](tbm-getbuddy.md)
-   [**TBM\_GETCHANNELRECT**](tbm-getchannelrect.md)
-   [**TBM\_GETLINESIZE**](tbm-getlinesize.md)
-   [**TBM\_GETNUMTICS**](tbm-getnumtics.md)
-   [**TBM\_GETPAGESIZE**](tbm-getpagesize.md)
-   [**TBM\_GETPOS**](tbm-getpos.md)
-   [**TBM\_GETPTICS**](tbm-getptics.md)
-   [**TBM\_GETRANGEMAX**](tbm-getrangemax.md)
-   [**TBM\_GETRANGEMIN**](tbm-getrangemin.md)
-   [**TBM\_GETSELEND**](tbm-getselend.md)
-   [**TBM\_GETSELSTART**](tbm-getselstart.md)
-   [**TBM\_GETTHUMBLENGTH**](tbm-getthumblength.md)
-   [**TBM\_GETTHUMBRECT**](tbm-getthumbrect.md)
-   [**TBM\_GETTIC**](tbm-gettic.md)
-   [**TBM\_GETTICPOS**](tbm-getticpos.md)
-   [**TBM\_GETTOOLTIPS**](tbm-gettooltips.md)
-   [**TBM\_GETUNICODEFORMAT**](tbm-getunicodeformat.md)
-   [**TBM\_SETBUDDY**](tbm-setbuddy.md)
-   [**TBM\_SETLINESIZE**](tbm-setlinesize.md)
-   [**TBM\_SETPAGESIZE**](tbm-setpagesize.md)
-   [**TBM\_SETPOS**](tbm-setpos.md)
-   [**TBM\_SETPOSNOTIFY**](tbm-setposnotify.md)
...
-   [**TBM\_SETTIC**](tbm-settic.md)
-   [**TBM\_SETTICFREQ**](tbm-setticfreq.md)
-   [**TBM\_SETTIPSIDE**](tbm-settipside.md)
-   [**TBM\_SETTOOLTIPS**](tbm-settooltips.md)
