...
| <span id="SF_USECODEPAGE"></span><span id="sf_usecodepage"></span><dl> <dt>**SF\_USECODEPAGE**</dt> </dl> | **Rich Edit 3.0 and later:** Generates UTF-8 RTF and text using other code pages. The code page is set in the high word of *wParam*. For example, for UTF-8 RTF, set *wParam* to (CP\_UTF8 << 16) \| SF\_USECODEPAGE \| SF\_RTF.<br/>                               |
