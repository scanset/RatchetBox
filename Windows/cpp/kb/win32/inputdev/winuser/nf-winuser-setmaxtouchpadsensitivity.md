...
Note that the last value of *forceMaxSensitivity* is respected (as opposed to incrementing or decrementing a count that determines if the touchpad sensitivity is set to max).
