...
> [!NOTE]
> DirectML is in maintenance mode. If your PC runs Windows 11, version 24H2 (build 26100) or later, consider using [Windows ML](/windows/ai/windows-ml/) for accelerated machine learning model execution.
