...
| **CurVer** | Set the (Default) entry of this subkey to the most current version of this ProgID.<br> **Note:** Unless you have side-by-side application versions, that is, multiple versions installed on the same system, you should avoid using **CurVer**.<br> | 
