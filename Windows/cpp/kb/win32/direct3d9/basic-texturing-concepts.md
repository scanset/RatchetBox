...
In addition, Direct3D supports more advanced texturing techniques such as texture blending-with or without transparency-and light mapping. For more information, see [Texture Blending (Direct3D 9)](texture-blending.md) and [Light Mapping with Textures (Direct3D 9)](light-mapping-with-textures.md).
...
-   [Texture Addressing Modes (Direct3D 9)](texture-addressing-modes.md)
-   [Texture Dirty Regions (Direct3D 9)](texture-dirty-regions.md)
-   [Texture Palettes (Direct3D 9)](texture-palettes.md)
