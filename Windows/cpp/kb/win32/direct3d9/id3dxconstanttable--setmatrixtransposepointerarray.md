# ID3DXConstantTable::SetMatrixTransposePointerArray method
...
Unique identifier to the array of matrix constants. See [D3DXHANDLE](dx9-graphics-reference-effects-constants.md).
