...
If sizeof...(MutexTypes) == 1, member type mutex_type is the same as Mutex, the sole type in MutexTypes....
...
redundant deduction guide from scoped_lock<MutexTypes...> was provided
