...
the callable target (function, member function, lambda expression, function object) to execute
...
the parameter type of the copy constructor was packaged_task&
...
for overloads (2,3), F could be std::packaged_task<R(Args...)>
