...
buf_type(std::ios_base::in | std::ios_base::out)
...
buf_type(str, std::ios_base::in | std::ios_base::out, a)
...
{t, std::ios_base::in | std::ios_base::out, a}

(12)

move constructed from other's std::basic_iostream base
