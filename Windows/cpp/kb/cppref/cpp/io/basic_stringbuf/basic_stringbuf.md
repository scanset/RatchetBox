...
a std::basic_string used to initialize the buffer

t

-

an object (convertible to std::basic_string_view) used to initialize the buffer

a

-

another allocator used to construct the internal std::basic_string
...
1. overload (1) allocated no array object
...
overload (3) set epptr() to point one past the last underlying
