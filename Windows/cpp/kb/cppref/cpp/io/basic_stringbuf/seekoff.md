...
seekoff might succeed even if newoff + off
...
repositioning null gptr() and/or null pptr()
...
the end pointer could not be used to calculate newoff because it could
