...
slice of the elements to return

gslicearr

-

gslice of the elements to return

boolarr

-

mask of the elements to return

indarr

-

indices of the elements to return
...
the return type of overload (1) was T
...
the behavior was unclear for overloads
