...
T must meet the requirements of CopyConstructible. T must meet the requirements of CopyAssignable if list::operator= or list::assign is instantiated with T.
(until C++11)
...
201505L
(C++17)
Minimal incomplete type support
...
T was always required to be CopyAssignable

only required if operator= or
