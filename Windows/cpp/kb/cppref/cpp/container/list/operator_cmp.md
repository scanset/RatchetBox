...
lists whose contents to compare
...
1) true if the contents of the lists are equal, false otherwise.

2) true if the contents of the lists are not equal, false otherwise.
