...
element type; must be a complete object type that is not an abstract class type
...
202311L
(C++26)
Constructing std::span from a std::initializer_list
...
the declaration of span's destructor was unnecessary
...
a span of non-zero static extents was not a view
