...
deques whose contents to compare
...
1) true if the contents of the deques are equal, false otherwise.

2) true if the contents of the deques are not equal, false otherwise.
