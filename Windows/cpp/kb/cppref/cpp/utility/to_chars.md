...
202207L
(C++23)
Add constexpr modifiers to std::to_chars and std::from_chars overloads (1) for integral types
...
this function was in <utility> and used std::error_code
...
bool argument was accepted and promoted to int

rejected by a deleted overload

LWG 3373

C++17

std::to_chars_result might have additional members
