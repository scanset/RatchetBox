...
the tuple of values used to initialize each element of the tuple

p

-

the pair of values used to initialize both elements of the 2-tuple

u

-

the tuple-like object of values used to initialize each element of the tuple

a

-

the allocator to use in uses-allocator construction
...
tuple-like constructor may potentially create dangling references
...
some constructors were explicit, preventing useful behavior
