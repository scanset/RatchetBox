...
valid character range to parse

value

-

the out-parameter where the parsed value is stored if successful
...
201611L
(C++17)
Elementary string conversions (std::from_chars, std::to_chars)
...
202207L
(C++23)
Add constexpr modifiers to std::from_chars and std::to_chars overloads for integral types
...
std::from_chars_result might have additional members
