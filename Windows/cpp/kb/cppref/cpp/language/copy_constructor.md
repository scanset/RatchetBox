...
- No copy constructor whose associated constraints are satisfied is more constrained.
...
the conditions where implicitly-declared copy constructors
...
volatile members make copy non-trivial (CWG issue 496)
...
a copy constructor was not eligible if there is
