...
any name in a template argument in a friend
member function declaration was not looked
up in the scope of the member function's class

only excludes the names
...
any unqualified name used in namespace
scope was first looked up in that scope

the unqualified names used to define a
