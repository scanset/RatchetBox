...
- T_func* can be converted to T_call* via a function pointer conversion.
...
the result of pointer conversions was unspecified
...
it was unclear which identity conversion
...
reinterpret_cast could only cast
lvalues to reference types

xvalues also allowed

CWG 2780

C++98

reinterpret_cast could not cast
...
reinterpret_cast could cast
prvalues to rvalue reference types
...
permissive conversions between types
