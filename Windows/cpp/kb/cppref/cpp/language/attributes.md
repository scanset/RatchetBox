...
[[ could not appear inside an attribute argument
...
it was unclear whether standard attributes can be syntactically ignored
...
it was unclear whether standard attributes can be semantically ignored
...
every standard attribute was required to appear at most once in an attribute-list
...
1. 
Attributes in GCC. These attributes can be used as [[gnu::...]], See SO.
