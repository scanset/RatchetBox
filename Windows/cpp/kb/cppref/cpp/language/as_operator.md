...
a parameter list of only one parameter, which is of type T, T&, const T&, volatile T& or const volatile T& and does not have a default argument

function-body

-

the function body of the copy assignment operator
...
- No copy assignment operator whose associated constraints are satisfied is more constrained.
...
the conditions where implicitly-declared copy assignment operators
...
a volatile subobject made defaulted copy
...
operator=(X&) = default was non-trivial
...
a defaulted copy assignment operator for class T was not defined as deleted
...
a copy assignment operator was not eligible if there
