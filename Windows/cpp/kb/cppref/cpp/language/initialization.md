...
a comma-separated list of initializer clauses (see below)
...
- If T is an aggregate, aggregate initialization applies.

- If T is a scalar type, T x = { a }; is equivalent to T x = a;.

- Otherwise, the program is ill-formed.

(until C++11)

- If the initializer is of syntax (2) or (4), the object is list-initialized.
...
the order of initializing static data members
...
non-local references with static storage duration were
...
it was unclear whether evaluating function
