...
char is not guaranteed to be able to represent UTF-8 code unit 0x80
...
cv-qualified std::nullptr_t was not a fundemental type
...
the ranges of representable values for floating-point types were not specified
...
wchar_t was required to be able to represent distinct codes for all members
