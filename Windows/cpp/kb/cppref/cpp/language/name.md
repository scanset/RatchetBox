...
- a pack indexing specifier denoting a class or enumeration type.
...
decltype expressions preceding :: could denote any type
...
implementation-defined characters other than digits, non-digits
...
the identifier in user-defined-string-literal of
...
&a was not transformed into &this->a in class contexts
...
the type of an identifier expression was unclear
