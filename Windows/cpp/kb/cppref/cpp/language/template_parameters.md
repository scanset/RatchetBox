...
template-template arguments had to match parameter
...
null pointer values could not be non-type template arguments
...
template non-type arguments could not have type std::nullptr_t
...
template non-type arguments could designate addresses of subobjects
...
it was unclear whether the closure type is structural
...
the closure type was not structural
