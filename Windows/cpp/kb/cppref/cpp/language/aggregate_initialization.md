...
when a character array is initialized with a string literal
...
a class that declares an explicit default constructor or
...
it was unclear whether brace elision is
applicable during array size deduction
...
a non-static reference member that is not explicitly
...
a UTF-8 string literal could not initialize an array of char
