...
(since C++17) any of the following:
...
a converted constant expression of the adjusted type of the switch condition
...
condition ﻿s of types that are not subject to
...
condition could be a declaration of a floating-point variable
