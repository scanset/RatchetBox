...
the type of the iterator that the ranges::in_found_result stores.
...
a value (that is supposed to be an iterator) of type I. It is declared with [[no_unique_address]] attribute. 
(public member object)

found

a boolean flag (that may show whether an appropriate range can be found) of type bool. 
(public member object)
