...
path to the source file, directory, or symlink

to

-

path to the target file, directory, or symlink
...
attempting to create a symlink for a directory succeeds but does nothing
