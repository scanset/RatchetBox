...
- ↑ per DR471, this only holds for non-zero x. If z is 0+∞i, the result should be 0+NaNi

- ↑ per DR471, this only holds for non-zero x. If z is 0+NaNi, the result should be 0+NaNi
