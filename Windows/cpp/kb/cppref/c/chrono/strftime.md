...
pointer to a struct tm object specifying the time to format
...
writes abbreviated month name in the locale's alternative representation
...
writes appropriate full month name in the locale's alternative representation
