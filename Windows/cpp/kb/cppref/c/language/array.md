...
3) Declarator for VLA of unspecified size (can appear in function prototype scope only)
where
...
(C23)optional list of attributes, applied to the declared array
...
- as the operand of _Alignof(since C11)(until C23)alignof(since C23)
