...
dereference the pointer a to access the object or function it refers to
...
create a pointer that refers to the object or function a
...
access member b of struct or union a
...
access member b of struct or union pointed to by a
...
an expression of type pointer to complete object
...
an expression of any pointer type
...
an lvalue expression of any type that is not a bit-field and does not have register storage class
...
an expression of struct or union type

member-name

-

an identifier that names a member of the struct or union designated by expression
...
an expression of type pointer to struct or union

member-name

-

an identifier that names a member of the struct or union pointed by expression
...
unnessary indirection could not be cancelled by &
