...
Window-TinyLFU: a small admission window plus a main segmented-LRU cache, with a frequency sketch deciding whether to admit a new entry over the eviction victim - high hit ratio at bounded memory. Keywords: tinylfu w-tinylfu wtinylfu admission eviction policy victim evict hit ratio frequency window probation protected bounded cache.

## source: internal/tlfu.go (from theine-go, MIT)
