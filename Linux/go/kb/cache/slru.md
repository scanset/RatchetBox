# Segmented LRU (SLRU) eviction

Segmented LRU: a probation segment and a protected segment, so frequently-reused entries survive longer than one-hit-wonders; the main cache structure under TinyLFU. Keywords: slru segmented lru eviction probation protected promote list recency.

## source: internal/slru.go (from theine-go, MIT)
