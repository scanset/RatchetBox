# go/doc (Go standard library)

Package doc extracts source code documentation from a Go AST.

Import path: go/doc   Toolchain: go1.26.4
...
func NewFromFiles(fset *token.FileSet, files []*ast.File, importPath string, opts ...any) (*Package, error)
    ...
    function, method, or the package, based on their name. If the example has
    a suffix in its name, it is set in the Example.Suffix field. Examples with
