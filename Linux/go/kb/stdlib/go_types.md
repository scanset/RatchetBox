...
func NewAlias(obj *TypeName, rhs Type) *Alias
    NewAlias creates a new Alias type with the given type name and rhs. If rhs
    is nil, the alias is incomplete.
...
func NewSignatureType(recv *Var, recvTypeParams, typeParams []*TypeParam, params, results *Tuple, variadic bool) *Signature
    ...
    parameter must be an unnamed slice or a type parameter whose type set has an
    unnamed slice as common underlying type.
    ...
    containing a mix of byte slices and string types in its type set. It may
    even be a named []byte slice type resulting from instantiation of such a
    type parameter.
...
func (s *Signature) Params() *Tuple
    Params returns the parameters of signature s, or nil. See NewSignatureType
    for details of variadic functions.
...
func Unalias(t Type) Type
    ...
    Consequently, the result is never an alias type. Returns nil if the alias is
    incomplete.
...
type Var struct {
    ...
    A Var represents a declared variable (including function parameters and
