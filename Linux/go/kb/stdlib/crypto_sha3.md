...
type SHA3 struct {
    ...
    SHA3 is an instance of a SHA-3 hash. It implements hash.Hash. The zero value
    is a usable SHA3-256 hash.
...
type SHAKE struct {
    ...
    SHAKE is an instance of a SHAKE extendable output function. The zero value
    is a usable SHAKE256 hash.
