# Observer (Behavioral Go design pattern)

Observer is a behavioral design pattern. Idiomatic Go implementation with a runnable example below.
...
## observer_test.go (runnable example)
