# Specification (Unsorted Go design pattern)

Specification is a unsorted design pattern. Idiomatic Go implementation with a runnable example below.
...
## specification_test.go (runnable example)
