# Iterator (Behavioral Go design pattern)

Iterator is a behavioral design pattern. Idiomatic Go implementation with a runnable example below.
...
## iterator_test.go (runnable example)
