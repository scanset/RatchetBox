# Mediator (Behavioral Go design pattern)

Mediator is a behavioral design pattern. Idiomatic Go implementation with a runnable example below.
...
## mediator_test.go (runnable example)
