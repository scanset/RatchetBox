# Visitor (Behavioral Go design pattern)

Visitor is a behavioral design pattern. Idiomatic Go implementation with a runnable example below.
...
## visitor_test.go (runnable example)
